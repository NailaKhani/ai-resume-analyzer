...
<div style="max-width: 760px; margin: 0 auto;">
    ...
    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
        ...
        <div>
            <h1 style="font-size: 1.85rem; font-weight: 900; color: #0F172A; margin: 0;">Create Job Posting</h1>
            <p style="color: #64748B; font-size: 0.9rem; margin: 0.2rem 0 0 0;">Fill in the details below to publish a new job opening.</p>
        </div>
    </div>
    ...
    <div class="glass-card" style="padding: 2.5rem;">
        <form method="POST" action="{{ route('jobs.store') }}">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. Senior Backend Laravel Developer">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" id="required_skills" name="required_skills" value="{{ old('required_skills') }}" placeholder="e.g. PHP, Laravel, MySQL, REST APIs, Docker">
                <p style="font-size: 0.78rem; color: #64748B; margin: 4px 0 0 0; font-weight: 600;">Separate skills with commas. These are parsed by AI to calculate candidate match scores.</p>
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea id="description" name="description" rows="8" placeholder="Detail the key responsibilities, requirements, and benefits for this position...">{{ old('description') }}</textarea>
                @error('description') <p style="color: #EF4444; font-size: 0.8rem; margin: 4px 0 0 0; font-weight: 600;">{{ $message }}</p> @enderror
            </div>

            <div style="display: flex; gap: 1rem; justify-content: flex-end;">
                <a href="{{ route('jobs.index') }}" style="padding: 0.75rem 1.6rem; background: #F1F5F9; color: #475569; border: 1px solid #CBD5E1; border-radius: 50px; font-weight: 700; font-size: 0.9rem; text-decoration: none;">Cancel</a>
