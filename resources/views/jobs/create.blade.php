...
<div style="max-width:760px;margin:0 auto;">
    ...
    <div style="display:flex;align-items:center;gap:1rem;margin-bottom:2rem;">
        ...
        <div>
            <h1 style="font-size:1.75rem;font-weight:900;color:#1e1b4b;margin:0;letter-spacing:-0.02em;">Create Job Posting</h1>
            <p style="color:#64748b;font-size:0.875rem;margin:0.2rem 0 0;">Fill in the details to publish a new job opening.</p>
        </div>
    </div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('jobs.store') }}">
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <input class="form-input" type="text" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. Senior Software Engineer">
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <input class="form-input" type="text" id="required_skills" name="required_skills" value="{{ old('required_skills') }}" placeholder="e.g. PHP, Laravel, MySQL, REST APIs">
                <p class="form-hint">Separate skills with commas. These are used by AI to calculate candidate match scores.</p>
                @error('required_skills') <p class="form-error">{{ $message }}</p> @enderror
            </div>

            <div style="margin-bottom:2rem;">
                <label class="form-label" for="description">Job Description</label>
                <textarea class="form-input" id="description" name="description" rows="8"
                    placeholder="Describe the role, responsibilities, qualifications, and any other requirements..." style="resize:vertical;">{{ old('description') }}</textarea>
